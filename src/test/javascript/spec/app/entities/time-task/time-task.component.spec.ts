...
import { TimeTaskComponent } from 'app/entities/time-task/time-task.component';
...
describe('Component Tests', () => {
    describe('TimeTask Management Component', () => {
        let comp: TimeTaskComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TimeTaskComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.timeTasks[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
